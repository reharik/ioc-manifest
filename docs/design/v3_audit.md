...
- Adoption ambition — gates docs investment, RESOLVER bridge, CLASSIC mode, and the emission-package extraction. The single strategic decision with the most downstream consequences.
