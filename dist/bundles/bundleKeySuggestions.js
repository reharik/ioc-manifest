 ...
 */
export const pickSimilarKeys = (target, candidates, limit) => {
    ...
    const head = target.includes(".")
        ...
        : target;
    const samePrefix = uniq.filter((k) => k === target || k === head || k.startsWith(`${head}.`));
...
//# sourceMappingURL=bundleKeySuggestions.js.map