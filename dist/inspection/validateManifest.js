const collectImpls = (impls) => Object.values(impls);
export const validateManifest = (manifestByContract) => {
    const issues = [];
...
const collectLeanImpls = (impls) => Object.values(impls);
export const validateContainerContractsView = (contracts) => {
    const issues = [];
...
export const validateBundleInsight = (insight) => {
